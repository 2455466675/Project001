...
public class AOTGenericReferences : UnityEngine.MonoBehaviour
{
	...
	// {{ AOT generic types
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask.<>c<GameFramework.Core.AssemblyManager.<Init>d__5>
	...
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask<GameFramework.Core.AssemblyManager.<Init>d__5>
	...
	public void RefMethods()
	{
		...
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.YieldAwaitable.Awaiter,GameFramework.Core.InputManager.<Init>d__4>(Cysharp.Threading.Tasks.YieldAwaitable.Awaiter&,GameFramework.Core.InputManager.<Init>d__4&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.YieldAwaitable.Awaiter,GameFramework.Featrue.EntityManager.<Init>d__4>(Cysharp.Threading.Tasks.YieldAwaitable.Awaiter&,GameFramework.Featrue.EntityManager.<Init>d__4&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.YieldAwaitable.Awaiter,GameFramework.SceneEntity.<LoadSceneAsync>d__16>(Cysharp.Threading.Tasks.YieldAwaitable.Awaiter&,GameFramework.SceneEntity.<LoadSceneAsync>d__16&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.YieldAwaitable.Awaiter,GameFramework.UI.InputController.<Init>d__4>(Cysharp.Threading.Tasks.YieldAwaitable.Awaiter&,GameFramework.UI.InputController.<Init>d__4&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.YieldAwaitable.Awaiter,GameFramework.UI.UIManager.<Init>d__8>(Cysharp.Threading.Tasks.YieldAwaitable.Awaiter&,GameFramework.UI.UIManager.<Init>d__8&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder<object>.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask.Awaiter<object>,GameFramework.Core.ResourceManager.<LoadAndInstantiateAsync>d__9>(Cysharp.Threading.Tasks.UniTask.Awaiter<object>&,GameFramework.Core.ResourceManager.<LoadAndInstantiateAsync>d__9&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder<object>.AwaitUnsafeOnCompleted<System.Runtime.CompilerServices.TaskAwaiter,GameFramework.Core.ResourceManager.<LoadAssetAsync>d__6<object>>(System.Runtime.CompilerServices.TaskAwaiter&,GameFramework.Core.ResourceManager.<LoadAssetAsync>d__6<object>&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Start<GameFramework.Core.AssemblyManager.<Init>d__5>(GameFramework.Core.AssemblyManager.<Init>d__5&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Start<GameFramework.Core.ConfigManager.<Init>d__5>(GameFramework.Core.ConfigManager.<Init>d__5&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Start<GameFramework.Core.EventManager.<Init>d__4>(GameFramework.Core.EventManager.<Init>d__4&)
