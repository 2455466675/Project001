...
public class AOTGenericReferences : UnityEngine.MonoBehaviour
{
	...
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask.<>c<GameFramework.Core.ConfigManager.<Init>d__3>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask.<>c<GameFramework.Core.GamePlayState.<SetProgress>d__5>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask.<>c<GameFramework.Core.SceneEntity.<LoadAsync>d__14>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask.<>c<GameFramework.Core.SceneEntity.<UnloadAsync>d__15>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask.<>c<GameFramework.Core.SceneManager.<Init>d__3>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask.<>c<GameFramework.Core.SceneManager.<LoadScene>d__4>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask.<>c<GameFramework.Game.<GetGamePriorityDatas>d__21,object>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask.<>c<GameFramework.Game.<InitGameModules>d__25>
	...
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask<GameFramework.Core.ConfigManager.<Init>d__3>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask<GameFramework.Core.GamePlayState.<SetProgress>d__5>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask<GameFramework.Core.SceneEntity.<LoadAsync>d__14>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask<GameFramework.Core.SceneEntity.<UnloadAsync>d__15>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask<GameFramework.Core.SceneManager.<Init>d__3>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask<GameFramework.Core.SceneManager.<LoadScene>d__4>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask<GameFramework.Game.<GetGamePriorityDatas>d__21,object>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTask<GameFramework.Game.<InitGameModules>d__25>
	...
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskVoid.<>c<GameFramework.Core.GamePlayState.<LoadGame>d__4>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskVoid<GameFramework.Core.GameLoginState.<LoadLogin>d__4>
	// Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskVoid<GameFramework.Core.GamePlayState.<LoadGame>d__4>
	...
	{
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask.Awaiter,GameFramework.Core.AssetsManager.<UnloadUnusedAssetsAsync>d__9>(Cysharp.Threading.Tasks.UniTask.Awaiter&,GameFramework.Core.AssetsManager.<UnloadUnusedAssetsAsync>d__9&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask.Awaiter,GameFramework.Core.SceneEntity.<LoadAsync>d__14>(Cysharp.Threading.Tasks.UniTask.Awaiter&,GameFramework.Core.SceneEntity.<LoadAsync>d__14&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask.Awaiter,GameFramework.Core.SceneEntity.<UnloadAsync>d__15>(Cysharp.Threading.Tasks.UniTask.Awaiter&,GameFramework.Core.SceneEntity.<UnloadAsync>d__15&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask.Awaiter,GameFramework.Core.SceneManager.<LoadScene>d__4>(Cysharp.Threading.Tasks.UniTask.Awaiter&,GameFramework.Core.SceneManager.<LoadScene>d__4&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask.Awaiter,GameFramework.Game.<InitGameModules>d__25>(Cysharp.Threading.Tasks.UniTask.Awaiter&,GameFramework.Game.<InitGameModules>d__25&)
		...
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask.Awaiter<object>,GameFramework.Gameplay.<Init>d__4>(Cysharp.Threading.Tasks.UniTask.Awaiter<object>&,GameFramework.Gameplay.<Init>d__4&)
		...
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Start<GameFramework.Core.GamePlayState.<SetProgress>d__5>(GameFramework.Core.GamePlayState.<SetProgress>d__5&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Start<GameFramework.Core.SceneEntity.<LoadAsync>d__14>(GameFramework.Core.SceneEntity.<LoadAsync>d__14&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Start<GameFramework.Core.SceneEntity.<UnloadAsync>d__15>(GameFramework.Core.SceneEntity.<UnloadAsync>d__15&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Start<GameFramework.Core.SceneManager.<Init>d__3>(GameFramework.Core.SceneManager.<Init>d__3&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Start<GameFramework.Core.SceneManager.<LoadScene>d__4>(GameFramework.Core.SceneManager.<LoadScene>d__4&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Start<GameFramework.Game.<InitGameModules>d__25>(GameFramework.Game.<InitGameModules>d__25&)
		...
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskVoidMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask.Awaiter,GameFramework.Core.GameLoginState.<LoadLogin>d__4>(Cysharp.Threading.Tasks.UniTask.Awaiter&,GameFramework.Core.GameLoginState.<LoadLogin>d__4&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskVoidMethodBuilder.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask.Awaiter,GameFramework.Core.GamePlayState.<LoadGame>d__4>(Cysharp.Threading.Tasks.UniTask.Awaiter&,GameFramework.Core.GamePlayState.<LoadGame>d__4&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskVoidMethodBuilder.Start<GameFramework.Core.GameLoginState.<LoadLogin>d__4>(GameFramework.Core.GameLoginState.<LoadLogin>d__4&)
		// System.Void Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskVoidMethodBuilder.Start<GameFramework.Core.GamePlayState.<LoadGame>d__4>(GameFramework.Core.GamePlayState.<LoadGame>d__4&)
		...
		// object ES3.Load<object>(string,string)
		// System.Void ES3.Save<object>(string,object,ES3Settings)
		// System.Void ES3.Save<object>(string,object,string)
		// byte[] ES3.Serialize<object>(object,ES3Settings)
