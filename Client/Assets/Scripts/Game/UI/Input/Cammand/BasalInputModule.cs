namespace Game.UI.Input
{
    ...
    public class BasalInputModule : InputModule
    {
        ...
        public override void Navigate(NavigationListDefine list_ID, int[] navigateIndexs, object intent)
        {
        ...
        protected override void OnInputAction(ActionContext context)
        {
            ...
            switch (inputType)
            {
                ...
                case InputType.GM:
                    ...
                    break;
                case InputType.Map:
                    Game.UI.Navigate(NavigationListDefine.Battle_Grid, ModuleType.Battle);
                    break;
            }
        }
