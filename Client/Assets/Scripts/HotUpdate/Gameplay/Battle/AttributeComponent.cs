...
namespace GameFramework.Gameplay
{
    ...
    public class AttributeComponent : Featrue.Component
    {
        ...
        /// 添加属性附加效果
        /// </summary>
        /// <param name="effectId">AttributeDefine + 偏移量。10000 ：百分比增加；20000 ：固定值增加；30000 ：百分比减少；40000 ：固定值减少</param>
        /// <param name="value"></param>
        public void AddAttributeEffect(int effectId, int value)
        {
        ...
        public int GetFinalValue(AttributeDefine define)
        {
            ...
            int value = Utility.Math.Floor((baseValue + bValue) * (1 + erValue / 10000f) / (1 + edrValue / 10000f) + epValue - edpValue);
            return value;
        }
