...
namespace Game.Core
{
    ...
    public abstract class InputActionWrapper
    {
        ...
        /// 将行为添加到持续性列表
        /// </summary>
        protected void PushContinued() 
        {
            GameWorld.Instance.GetComponent<InputComponent>().PushAction(this);
        }

        /// <summary>
        /// 从持续性列表中移除行为
        /// </summary>
        protected void PopContinued()
        {
            GameWorld.Instance.GetComponent<InputComponent>().PopAction(this);
        }
    }
}
