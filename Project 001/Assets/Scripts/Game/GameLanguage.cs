...
namespace Config
{
    ...
    public class GameLanguage 
    {
        ...
        public LanguageItem GetLanguageItem(int id)
        {
            ...
            LanguageCfg cfg = GameWorld.Root.GetComponent<ConfigComponent>().Find<LanguageCfg>(id);
            if (cfg == null)
            {
        ...
        {
            ColorCfg cfg = GameWorld.Root.GetComponent<ConfigComponent>().Find<ColorCfg>(colorId);
            if (cfg == null)
            {
